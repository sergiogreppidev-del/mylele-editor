...
function promptNivelCompleto(o: PromptOptions): string {
  ...
  return [
    ...
    'Fijate: el primer compás tiene UN solo tiempo (las dos corcheas de "Fe-liz"), y el tiempo',
    'fuerte cae en el segundo compás. Los tres renglones arrancan con esa misma anacrusa.',
    'BPM: 120',
    'COMPAS: 3/4',
    'FONDO: | r/1 | [C3,E3,G3]/3 | [C3,E3,G3]/3 |',
